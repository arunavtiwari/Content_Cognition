...
- Weighted ranking model:
  ...
  - `BrandFitScore`
  - `NoveltyScore`
- Interactive motion-first Browser UI with a dedicated Home page at `/`, plus a separate Creative Studio view, 3D hero object (Three.js), and modern interactive elements.
